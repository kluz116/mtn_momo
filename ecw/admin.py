...
class CustomUserAdmin(UserAdmin):
    ...
    model = EcwUser
    list_display = ("email", "is_staff", "is_active","branch","group","firstname","lastname","needs_password_change","operator_id",)
    list_filter = ("email", "is_staff", "is_active","branch","group","firstname","lastname","needs_password_change","operator_id",)
    fieldsets = (
